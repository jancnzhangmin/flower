...
var __parent0=require('$model/UI2/flowerfront/ower/comment'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='cjiErqy';
	this._flag_='58da081f2454953ef6768102bd3bc3fc';
	this._wCfg_={};
	this._appCfg_={};
	this.callParent(contextUrl);
 require('css!$UI/flowerfront/icon2/my2.icons').load();
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":true,"confirmDelete":false,"confirmRefresh":true,"defCols":{"id":{"define":"id","name":"id","relation":"id","type":"String"},"image":{"define":"image","name":"image","relation":"image","type":"String"},"isnull":{"define":"isnull","name":"isnull","relation":"isnull","type":"String"}},"directDelete":false,"events":{},"idColumn":"id","isMain":false,"limit":20,"xid":"imageData"});
}}); 
return __result;});

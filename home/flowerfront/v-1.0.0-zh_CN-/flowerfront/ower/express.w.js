...
var __parent0=require('$model/UI2/flowerfront/ower/express'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='crqqMNb';
	this._flag_='03b95707c1d3a62b2cf1e11c7fef967c';
	this._wCfg_={};
	this._appCfg_={};
	this.callParent(contextUrl);
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"id":{"define":"id","name":"id","relation":"id","type":"String"},"message":{"define":"message","name":"message","relation":"message","type":"String"},"name":{"define":"name","name":"name","relation":"name","type":"String"},"nu":{"define":"nu","name":"nu","relation":"nu","type":"String"},"state":{"define":"state","name":"state","relation":"state","type":"String"}},"directDelete":false,"events":{},"idColumn":"id","isMain":false,"limit":20,"xid":"expressData"});
 new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"context":{"define":"context","name":"context","relation":"context","type":"String"},"express_id":{"define":"express_id","name":"express_id","relation":"express_id","type":"String"},"ffirst":{"define":"ffirst","name":"ffirst","relation":"ffirst","type":"String"},"ftime":{"define":"ftime","name":"ftime","relation":"ftime","type":"String"},"id":{"define":"id","name":"id","relation":"id","type":"String"}},"directDelete":false,"events":{},"idColumn":"id","isMain":false,"limit":20,"xid":"detailData"});
}}); 
return __result;});
